...
import io.bega.kduino.datamodel.pages.CustomerInfoPage;
...
public class KduinoWizardDataModel extends AbstractWizardModel {
    public KduinoWizardDataModel(Context context) {
        super(context);
    }
