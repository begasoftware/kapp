 ...
 */
public class ConnectBluetooth extends AsyncTask<String, Integer, Void> {
    ...
    public ConnectBluetooth(Bus bus, Activity activity, BluetoothService service, KDUINOBuoy buoy)
    {
        this.buoy = buoy;
        this.bus = bus;
